...
func (l byNameAndStage) Len() int           { _ = "STUB: not implemented"; return 0 }
func (l byNameAndStage) Swap(i, j int)      { _ = "STUB: not implemented"; return }
func (l byNameAndStage) Less(i, j int) bool { _ = "STUB: not implemented"; return false }
