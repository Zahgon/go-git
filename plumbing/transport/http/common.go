...
func schemeUpgrade(from, to string) bool { _ = "STUB: not implemented"; return false }

func canonicalHost(u *url.URL) string { _ = "STUB: not implemented"; return "" }

func effectivePort(u *url.URL) string { _ = "STUB: not implemented"; return "" }

func credentialsMayFollow(from, to *url.URL) bool { _ = "STUB: not implemented"; return false }
