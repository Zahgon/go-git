...
func isPartialClone(s storage.Storer) bool { _ = "STUB: not implemented"; return false }

func (p *objectWalker) present() []plumbing.Hash { _ = "STUB: not implemented"; return nil }
