...
func (r *Remote) recordPromisor(filter packp.Filter) error { _ = "STUB: not implemented"; return nil }
...
func checkTagUpdate(cmd *packp.Command) error { _ = "STUB: not implemented"; return nil }
